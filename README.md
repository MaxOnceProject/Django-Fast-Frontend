...
FRONTEND_DESCRIPTION = ""  # Description for your frontend
FRONTEND_AUTO_URL = False  # Whether to generate URLs automatically
FRONTEND_URL = ''  # Base URL for frontend views
FRONTEND_AUTHENTICATION = False  # Whether authentication is required
