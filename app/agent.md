...
themes, toolbar/inline buttons, and custom actions.
...
| `app/frontend.py` | Full-featured `AuthorFrontend` — search, filter, sort, cards, toolbar/inline buttons (31 lines) | `AuthorFrontend`, `AuthorFrontend.everything()`, `.everything_everything()`, `.check()`, `.uncheck()` |
